...
def randomNeighbour(chemin):
    ...
    random_point = random.randint(1,len(data)-2)
    temp = neighbour.coords[random_point]
    neighbour.coords[random_point] = neighbour.coords[random_point+1]
    neighbour.coords[random_point+1] = temp
    return neighbour
